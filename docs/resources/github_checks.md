...
- `control` (String) Control name. Available controls: Maven Package Compromised Updates, Maven Package Cooldown, NPM Package Compromised Updates, NPM Package Cooldown, PWN Request, PyPI Package Compromised Updates, PyPI Package Cooldown, Script Injection
